;; vr-asset-registry
;; This contract manages the registration, ownership, and trading of virtual reality assets
;; on the Stacks blockchain. It provides a comprehensive system for creators to register
;; VR assets with detailed metadata, transfer ownership, list assets for sale, and
;; maintain provenance history. The contract facilitates a trustless marketplace
;; for the virtual reality asset economy.
;; Error Constants
